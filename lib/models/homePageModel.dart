...
class HomePage {
  ...
  HomePage.fromJson(Map<String, dynamic> json) {
    try {
      ...
      allOrders = json['all_orders_count'] != null ? int.parse('${json['all_orders_count']}') : null;
      pendingOrders = json['pending_orders'] != null ? int.parse('${json['pending_orders']}') : null;
      completedOrders = json['complted_order_count'] != null ? int.parse('${json['complted_order_count']}') : null;
      ...
      unread_notification_count = json['unread_notification_count'] != null ? int.parse('${json['unread_notification_count']}') : null;
      read_notification_count = json['read_notification_count'] != null ? int.parse('${json['read_notification_count']}') : null;
